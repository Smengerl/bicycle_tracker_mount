...
| ---------------------------------- | -------------------------------------------------------------------------------------| -------- | ------|
| `./print/lower_part.stl`          | <img src="./print/png/lower_part.png" alt="Lower half" width="300"/> | 1        |       |
| `./print/upper_part.stl`          | <img src="./print/png/upper_part.png" alt="Upper half" width="300"/> | 1        |       |
